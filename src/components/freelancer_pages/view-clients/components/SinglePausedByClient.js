...
import DefaultProfile from "../../images/avatar-s-18.png"
...
const ContactModal = (props) => {
  ...
  const {
    ...
    first_name,
    last_name,
  } = props.client.client.user_profile
  const { email } = props.client.client
  return (
...
function SinglePausedByCLient(props) {
          ...
          <div className="row">
            <div className="col-md-4 pb-4 ">
              <Avatar
                alt="Profile"
                src={
                  client.client.user_profile.user_profile_image == null
                    ? DefaultProfile
                    : `http://localhost:3000/${client.client.user_profile.user_profile_image}`
                }
            ...
            <div className="col-md-6 pb-4 pt-0 pt-lg-3">
              <h4 className="text-color pb-2 h2">
                {client.client.user_profile.full_name == ""
                  ? `${client.client.user_profile.first_name} ${client.client.user_profile.last_name}`
                  : client.client.user_profile.full_name}
              </h4>
              <p className="pb-2">
                <strong>Status: </strong>
                <span className="text-info">
                  {client.client.is_active == true ? "Active" : "Offline"}
                </span>{" "}
                |<strong> Hours limit: </strong>
                <span className="text-info">
                  {client.client_project.client_budget[0].hourly_rate["9"]}{" "}
                </span>
              </p>
              <p className="pb-2">
            ...
            <div className="col-md-12 py-4 d-flex flex-column justify-content-between flex-lg-row">
              <p>
                ...
                <span className="text-info">
                  {client.client_project.project_detail}{" "}
                </span>{" "}
                |<strong> Project rate: </strong>
                <span className="text-success">
                  {client.client_project.client_budget[0].budget}{" "}
                </span>
              </p>
