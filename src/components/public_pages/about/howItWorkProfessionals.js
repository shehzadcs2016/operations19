...
const howItWorkProfessionals = () => {
  return (
    <React.Fragment>
            ...
            <div className="col-lg-12 col-md-12 col-sm-12">
              <div className="blog-hero-area">
                <div className="blog-category-title Platform HIT_banner custom_subheader">
                  <h2>How It Works<br />For Professionals </h2>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="padding_80">
        <div className="container">
          <div className="row justify-content-center">
            <div className="col-md-6 padding_left_rigt_join">
              <div className="short_heading join_heading_style">
                <h3>Join Operations19 And Grow Your Business </h3>
                <p className="mt-3">Operations19 is a best-in-class “service for hire” platform that connects top-rated service providers with successful brands to execute their one-time or repetitive tasks.</p>
                <p className="mt-3">Our network of businesses purchases services in e-commerce, Amazon, marketing, writing, accounting, admin and support, graphics and design, as well as web/mobile and software development.</p>
              </div>
            </div>
            <div className="col-md-5 ri8_image_join_sty">
              <img src="/images/Masked-Image_professinal.png" alt="" />
            </div>
      ...
      <section id="  " className="how-it-works wfp_padding">
        <div className="container">
          <div className="row">
            <div className="col-lg-12 col-md-12 col-sm-12">
          ...
          <div className="row">
            <div className="col-sm-12 col-md-12 col-lg-12">
              ...
              <div className="get-started-wrapper howitwork_padding hhit_work_padding">
                <div className="row justify-content-center">
                  <div className="col-sm-12 col-md-4 col-lg-4 mobile-padding how_it_works_detail">
                    <img src="img/dispute/circle1.png" alt="" /> 
                    <p>
                    Businesses submit service requests outlining their needs.
                     </p>
                  </div>
                  <div className="col-sm-12 col-md-4 col-lg-4 mobile-padding how_it_works_detail">
                    <img src="img/dispute/circle2.png" alt="" /> 
                    <p>Service providers submit fixed or hourly-priced proposals.</p>
                  </div> 
                  <div className="col-sm-12 col-md-4 col-lg-4 mobile-padding how_it_works_detail">
                    <img src="img/dispute/circle3.png" alt="" /> 
                    <p>Businesses accept your proposals, and working relationships are established.</p>

                  </div>
                  </div> 
                  <div className="dashed_line44">
                  </div>
                  <div className="dashed_line55">
                  </div> 
      ...
      <section id="Aboutus" className="padding_80 bg-light">
        <div className="container-fluid pl-0">
          <div className="row justify-content">
            <div className="col-md-4 left_side_image">
              <img className="helping_business_groth" src="/images/offer_services.png" alt="" />
            </div>
            <div className="col-md-8 helping_bussness_right" >
              <div className="row ">
                <div className="col-md-12">
                  <div className="short_heading">
                    <h3>Offer Your Services to Successful Brands Looking To Grow Their E-Commerce Business</h3>
                  </div>
                </div>
              </div>
              <div className="row point_heading  mt-2">
                <div className="col-md-6">
                  <h3>Exciting Clients</h3>
                  <p>You will have access to an exciting network of successful businesses. Operations19 invests heavily in onboarding enterprise and top-tier businesses.</p>
                </div>
                <div className="col-md-6">
                  <h3>Service Menus</h3>
                  <p>Create service menus to showcase and upsell your services to new and existing clients. </p>
                </div>
                <div className="col-md-6">
                  <h3>Project Management</h3>
                  <p>Access tools and resources to manage and communicate the status of your services to your clients.</p>
                </div>
                <div className="col-md-6">
                  <h3>Easy Billing and Payouts</h3>
                  <p>Operations19 takes 15% on all billed services generated through the platform. There are no additional fees. Manage your billed services, view payouts, and receive 24/7 customer support.</p>
                </div>
                <div className="col-md-6">
            ...
            <div className="col-md-4 left_side_our_history text-center">
              ...
              <div className="Our_history_button">
                <div className="get-button">
                  <Link to="/professional-application" className="fm_custom_btn_history mt-1">
                    Apply Now
                  </Link>
                </div>
              </div>
          ...
          <div className="row ">
            <div className="col-sm-12 col-md-12 col-lg-7">
              ...
              <div className="get-button float-left">
                <Link to="/professional-application" className="fm_custom_btn mt-1">
                  Apply Now
                  </Link>
              </div>
            </div>
